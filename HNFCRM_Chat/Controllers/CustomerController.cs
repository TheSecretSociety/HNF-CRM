...
namespace HNFCRM_Chat.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult CustomerDetail(int id)
        {
            ...
            var findcontract = entities.CONTRACTs.Where(x => x.ID_Customer == id).SingleOrDefault();
        ...
        public ActionResult CustomerDetail(int id, FormCollection frm)
        {
            ...
            {
                data.PreviousPrice = float.Parse(frm["previousprice"]);
            }
        ...
        public ActionResult DeleteCustomer(int id)
        {
            ...
            if (customercare != null)
            {
                ...
                CUSTOMERCAREDETAIL customercaredetail = entities.CUSTOMERCAREDETAILs.Where(x => x.ID_CustomerCare == customercare.ID).SingleOrDefault();
                Criterion criteria = entities.CRITERIA.Where(x => x.ID == customercaredetail.ID_Criteria).SingleOrDefault();
                entities.CUSTOMERCAREDETAILs.Remove(customercaredetail);
                entities.CRITERIA.Remove(criteria);
            }
            entities.SaveChanges();
            return RedirectToAction("Customer");
        }
        ...
        public ActionResult SearchCustomerByStaff(int id, int? page)
        {
            ...
            foreach (var item in findcontract)
            {
                ...
                var findstaff = entities.STAFFs.Where(x => x.ID == id).SingleOrDefault();
